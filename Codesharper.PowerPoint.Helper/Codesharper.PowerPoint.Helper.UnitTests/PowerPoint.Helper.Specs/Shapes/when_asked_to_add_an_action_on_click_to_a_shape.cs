namespace Codesharper.PowerPoint.Helper.Specs.PowerPoint.Helper.Specs
{
    ...
    public class when_asked_to_add_an_action_on_click_to_a_shape : SpecsFor<PresentationManager>
    {
        ...
        {
          this.shapesHandler.AddClickedActionToShape(this.returnedShape, PpActionType.ppActionNextSlide);
