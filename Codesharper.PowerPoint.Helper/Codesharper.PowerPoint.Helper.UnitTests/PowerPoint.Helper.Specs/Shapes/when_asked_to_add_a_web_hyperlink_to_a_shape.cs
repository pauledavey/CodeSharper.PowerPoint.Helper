namespace Codesharper.PowerPoint.Helper.Specs.PowerPoint.Helper.Specs
{
    ...
    public class when_asked_to_add_a_web_hyperlink_to_a_shape : SpecsFor<PresentationManager>
    {
        ...
        {
          this.shapesHandler.AddHyperLinkToWebsite(this.returnedShape, "http://www.codesharper.co.uk");
        ...
        [Test]
        public void then_the_shape_should_have_a_hyperLink_attached()
        {
            this.returnedShape.ActionSettings[PpMouseActivation.ppMouseClick].Action.ShouldEqual(
